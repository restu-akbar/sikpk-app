        ...
        >
            <nav class="flex items-center justify-end gap-4">
                <template v-if="$page.props.auth.user">
                    <!-- Tombol Landing Page untuk semua user yang sudah login -->
                    <Link
                        href="/landing"
                    ...
                    <!-- Dashboard: arahkan ke satgas atau reporter sesuai role -->
                    <Link
                        :href="$page.props.auth.user.role ? dashboard() : '/dashboard'"
